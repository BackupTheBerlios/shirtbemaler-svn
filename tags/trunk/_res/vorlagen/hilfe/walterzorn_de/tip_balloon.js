...
config. BalloonImgPath = "_system/_zusatz/tooltips/walterzorn_de/tip_balloon/" // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
