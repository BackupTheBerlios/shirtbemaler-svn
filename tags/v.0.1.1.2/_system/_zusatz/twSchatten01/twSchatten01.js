/**
Zum Anfügen von Schatten an ein Bild.
(einbinden in html siehe: 'test.html'
.............

1.<b> 
diese Datei und die css-Datei einbinden (in die html-Datei)

2. 
Einbinden (evtl. im head) z.B:
...
3. 
Aufruf im html z.B:
<img src="bild.jpg" class="schattenbild3" style="border:1px solid #000;" />
*/
 ...
 * twMachSchatten("img.schattenbild3","schatten3");
 */
function twMachSchatten(className, styleName){
	if(document.getElementsByTagName && document.createElement){
		// get all elements that match the specified css selector
		var elements = document.getElementsBySelector(className);
