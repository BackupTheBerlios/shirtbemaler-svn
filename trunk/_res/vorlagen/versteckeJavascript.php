...
/*
 * Habsch von ZenCart (includes/modules/pages/login/jscript_form_check.php).
 * Ist ein Beispiel, wie man Javascript in .php 'verstecken' kann ;-)
 * (Hier wird ein Formular geprüft...)
 */
